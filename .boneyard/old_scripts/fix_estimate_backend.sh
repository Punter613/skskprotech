...
echo "=========================================="
echo "🛠️ Aligning Estimate JSON Engine 🛠️"
echo "=========================================="
...
git commit -m "Force estimate route to output native JSON to populate frontend cards perfectly"
git push
echo "✅ Estimate backend updated!"
rm fix_estimate_backend.sh
